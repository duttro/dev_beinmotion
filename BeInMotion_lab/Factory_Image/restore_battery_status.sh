...
# Programming File: "Battery_Status_epcs.flash" To Device: epcs
#
nios2-flash-programmer "Battery_Status_epcs.flash" --base=0x21800 --epcs --sidp=0x60 --id=0x0 --timestamp=1312222159 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program --verbose 
