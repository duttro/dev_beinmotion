...
//   output_name:         BeInMotion_qsys_cmd_xbar_demux_001
//   ST_DATA_W:           77
//   ST_CHANNEL_W:        30
//   NUM_OUTPUTS:         30
//   VALID_WIDTH:         1
...
module BeInMotion_qsys_cmd_xbar_demux_001
(
    // -------------------
    // Sink
    // -------------------
    ...
    output reg [77-1    : 0] src2_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src3_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src4_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src5_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src6_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src7_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src8_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src9_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src10_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src11_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src12_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src13_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src14_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src15_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src16_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src17_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src18_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src19_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src20_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src21_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src22_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src23_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src24_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src25_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src26_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src27_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src28_data, // ST_DATA_W=77
    ...
    output reg [77-1    : 0] src29_data, // ST_DATA_W=77
