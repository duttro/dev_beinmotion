...
set_location_assignment PIN_R16 -to dc_psave
set_location_assignment PIN_R7 -to CPU_RST_N
set_location_assignment PIN_E1 -to CLK_FPGA_50M

set_location_assignment PIN_P16 -to gauge_scl
set_location_assignment PIN_L2 -to gauge_sda
set_location_assignment PIN_P11 -to gauge_cc_al_n

set_location_assignment PIN_J13 -to user_led[0]
set_location_assignment PIN_T10 -to user_led[1]
set_location_assignment PIN_T11 -to user_led[2]

set_location_assignment PIN_P14 -to gpio[0]
set_location_assignment PIN_N14 -to gpio[1]
set_location_assignment PIN_G1 -to gpio[2]
set_location_assignment PIN_L14 -to gpio[3]
set_location_assignment PIN_N11 -to gpio[4]
set_location_assignment PIN_N12 -to gpio[5]
set_location_assignment PIN_G2 -to gpio[6]
set_location_assignment PIN_F2 -to gpio[7]

set_location_assignment PIN_T9 -to pb[0]
set_location_assignment PIN_T3 -to pb[1]
set_location_assignment PIN_T8 -to pb[2]
set_location_assignment PIN_M10 -to pb[3]
set_location_assignment PIN_R8 -to pb[4]
set_location_assignment PIN_T7 -to pb[5]
set_location_assignment PIN_R9 -to pb[6]

set_location_assignment PIN_J14 -to ir_led1
set_location_assignment PIN_P6 -to ir_led2
set_location_assignment PIN_L16 -to ir_rx1
set_location_assignment PIN_P1 -to ir_rx2

set_location_assignment PIN_L3 -to dc_pwm[0]
set_location_assignment PIN_N2 -to dc_pwm[1]
set_location_assignment PIN_N3 -to dc_pwm[2]
set_location_assignment PIN_L4 -to dc_pwm[3]


set_location_assignment PIN_N8 -to stm_out[0]
set_location_assignment PIN_M7 -to stm_out[1]
set_location_assignment PIN_R3 -to stm_out[2]
set_location_assignment PIN_P8 -to stm_out[3]

set_location_assignment PIN_N16 -to stm_sdi
set_location_assignment PIN_P3 -to stm_sdo
set_location_assignment PIN_N1 -to stm_sck
set_location_assignment PIN_L1 -to stm_cnv

set_location_assignment PIN_K2 -to lcd_cs_n
set_location_assignment PIN_F3 -to lcd_reset_n
set_location_assignment PIN_K1 -to lcd_rs

set_location_assignment PIN_M8 -to lcd_d[0]
set_location_assignment PIN_L8 -to lcd_d[1]
set_location_assignment PIN_P2 -to lcd_d[2]
set_location_assignment PIN_L7 -to lcd_d[3]
set_location_assignment PIN_N6 -to lcd_d[4]
set_location_assignment PIN_M6 -to lcd_d[5]
set_location_assignment PIN_R1 -to lcd_d[6]
set_location_assignment PIN_T2 -to lcd_d[7]
set_location_assignment PIN_N5 -to lcd_rd_n
set_location_assignment PIN_G5 -to lcd_wr_n

set_location_assignment PIN_K15 -to ps_dout
set_location_assignment PIN_L15 -to ps_led_on
set_location_assignment PIN_F1 -to ps_enb

set_location_assignment PIN_J2 -to ps_scl
set_location_assignment PIN_J1 -to ps_sda

set_location_assignment PIN_H2 -to data_0
...
set_global_assignment -name VERILOG_FILE BeInMotion.v
set_global_assignment -name QIP_FILE BeInMotion_qsys/synthesis/BeInMotion_qsys.qip
set_global_assignment -name SDC_FILE BeInMotion.sdc

set_global_assignment -name SEARCH_PATH BeInMotion_qsys/synthesis/ -tag from_archive
set_global_assignment -name SEARCH_PATH BeInMotion_qsys/synthesis/submodules/ -tag from_archive
...
#set_location_assignment PIN_A6 -to RAM_DQS[1]
#set_location_assignment PIN_C8 -to RAM_DQS[0]
#set_location_assignment PIN_D3 -to RAM_BA[1]
#set_location_assignment PIN_D5 -to RAM_BA[0]
#set_location_assignment PIN_A4 -to RAM_DQM[1]
#set_location_assignment PIN_D9 -to RAM_DQM[0]
...
#set_instance_assignment -name IO_STANDARD "1.8 V" -to RAM_BA[0]
#set_instance_assignment -name IO_STANDARD "1.8 V" -to RAM_BA[1]
...
#set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to RAM_*DQS -disable -comment "Ignored by fitter, disabling"
...
#set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to RAM_D* -disable -comment "Ignored by fitter, disabling"
#set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to RAM_D* -disable -comment "Ignored by fitter, disabling"
...
#set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to sdram_cas
#set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to sdram_ras
#set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to sdram_we
#set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to sdram_dq
#set_instance_assignment -name FAST_OUTPUT_ENABLE_REGISTER ON -to sdram_dqs
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_clk_out_p
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_clk_out_n
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_ba
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_a
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_cs
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_cas
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_ras
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_we
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_dqm
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_dq
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_dqs
#set_instance_assignment -name IO_STANDARD "1.8 V" -to sdram_cke
#set_instance_assignment -name OUTPUT_ENABLE_GROUP 22 -to sdram_dq
#set_instance_assignment -name OUTPUT_ENABLE_GROUP 22 -to sdram_dqs
#set_instance_assignment -name OUTPUT_ENABLE_GROUP 22 -to sdram_dqm
#set_instance_assignment -name PAD_TO_CORE_DELAY 0 -to sdram_dq
#set_instance_assignment -name DUAL_PURPOSE_CLOCK_PIN_DELAY 5 -to sdram_dqs
#set_global_assignment -name FMAX_REQUIREMENT "133 MHz" -section_id sdram_dqs_clock
#set_instance_assignment -name CLOCK_SETTINGS sdram_dqs_clock -to sdram_dqs
